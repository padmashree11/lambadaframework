...
public final class S3UtilsTest {
    ...
    public void getBucketName() {
        assertEquals("maven.cagataygurturk.com", S3Utils.getBucketName(createRepository("/")));
    }
    ...
    private Repository createRepository(String path) {
        return new Repository("foo", String.format("s3://maven.cagataygurturk.com%s", path));
    }
}
